 ...
 */
static inline void	libMU_Statistics_Initialize( libMU_Statistics_t* est )
{
	est->max = 0;
	est->min = UINT64_MAX;
	est->count = 0;
...
void	libMU_Statistics_Update(
					...
					libMU_Timer_Stopwatch_t	tiempo );
 ...
 */
static inline libMU_Timer_Stopwatch_t	libMU_Statistics_GetMaxValue( libMU_Statistics_t* est )
{
	return (libMU_Timer_Stopwatch_t)est->max;
}
 ...
 */
static inline libMU_Timer_Stopwatch_t	libMU_Statistics_GetMinValue( libMU_Statistics_t* est )
{
	return (libMU_Timer_Stopwatch_t)est->min;
}
 ...
 */
static inline libMU_Timer_Stopwatch_t	libMU_Statistics_GetMeanValue( libMU_Statistics_t* est )
{
	return (libMU_Timer_Stopwatch_t)(est->sum/est->count);
}
...
{
	libMU_Timer_Stopwatch_t t = libMU_Statistics_GetMeanValue( est );
